...
$message .= ' <table border="0" cellpadding="0" cellspacing="0" width="600" align="center" style="width:600px;">
         <tr>
                                                ...
                                                <tr>
                                                   <td style="word-break:break-word;font-size:0px;padding:10px 25px;padding-top:30px;" align="center">
                                                      <table cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0">
                                                         <tbody>
                                                            <tr>
                                                               <td style="width:80px;"><img alt="Zero To Launch" title="" height="auto" src="https://cdn.auth0.com/website/emails/product/top-verify.png" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:auto;" width="80"></td>
                                                            </tr>
                                                         </tbody>
                                                      </table>
                                                   </td>
                                          ...
                                          <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                             <tbody>
                                                <tr>
                                                   <td style="word-break:break-word;font-size:0px;padding:0px 0px 25px;" align="left">
                                                      <div style="cursor:auto;color:#222228;font-family:Avenir Next, Avenir, sans-serif;font-size:16px;line-height:30px;">
                                                         <a href="#" style="color:#0a84ae; text-decoration:none" target="_blank">http://localhost/emailverification.php?id='.$username.'&'.$rndno.'</a>
                                                      </div>
                                                   </td>
                                                </tr>
                                             </tbody>
                                                ...
                                                <tr>
                                                   <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center">
                                                      <table cellpadding="0" cellspacing="0" align="center" border="0">
                                                         <tbody>
                                                            <tr>
                                                               <td style="border-radius:3px;color:white;cursor:auto;" align="center" valign="middle" bgcolor="#EB5424"><a href="http://localhost/emailverification.php?id='.$username.'&'.$rndno.'" style="display:inline-block;text-decoration:none;background:#EB5424;border-radius:3px;color:white;font-family:Avenir Next, Avenir, sans-serif;font-size:14px;font-weight:500;line-height:35px;padding:10px 25px;margin:0px;" target="_blank">
                                                                  VERIFY YOUR ACCOUNT
                                                                  </a>
                                                               </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                   <td style="word-break:break-word;font-size:0px;padding:0px 20px;" align="center">
                                                      <div style="cursor:auto;color:#222228;font-family:Avenir Next, Avenir, sans-serif;font-size:13px;line-height:20px;">
                                                         You’re receiving this email because you have an account in sdnonlinelab.com.
...
// your gmail address
$mail->Username = 'solsupport@cdac.in';

// your password must be enclosed in single quotes
$mail->Password = 'iwilldoit12!@';

// add a subject line
$mail->Subject = 'Email Verification Mail - SOL Team ';

// Sender email address and name
$mail->SetFrom('solsupport@cdac.in', 'SOL Team');
