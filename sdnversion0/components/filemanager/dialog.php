...
switch($_GET['action']){
    ...
    <input type="text" class="form-control" name="object_name" autofocus="autofocus" autocomplete="off">
    ...
    <input type="text" name="object_name" class="form-control" autofocus="autofocus" autocomplete="off" value="<?php echo($_GET['short_name']); ?>">
    ...
    <pre><?php if(!FileManager::isAbsPath($_GET['path'])) { echo '/'; }; echo($_GET['path']); ?></pre>
    <select name="or_action" class="form-control">
    ...
    <table class="file-search-table">
        <tr>
            <td width="65%">
               ...
               <input type="text" class="form-control" name="search_string" autofocus="autofocus">
            </td>
            <td width="5%">&nbsp;&nbsp;</td>
            <td>
        ...
        <tr>
            <td colspan="3">
               ...
               <input type="text" class="form-control" name="search_file_type" placeholder="<?php i18n("space seperated file types eg: js c php"); ?>">
            </td>
        </tr>
    </table>
