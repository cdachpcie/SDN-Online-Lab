    ...
    */
    ...
    switch($_GET['action']){
        ...
        case 'create':
            ...
            <input type="text" name="username" class="form-control" autofocus="autofocus" autocomplete="off">
        ...
        ?>
            ...
            <input type="password" class="form-control" name="password1" autofocus="autofocus">
            <label><?php i18n("Confirm Password"); ?></label>
            <input type="password" class="form-control" name="password2">
