...
<table class="settings">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.theme">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.fontSize">
    ...
    <tr>
        ...
        <td>
            ...
            <select class="setting form-control" data-setting="codiad.editor.highlightLine">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.indentGuides">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.printMargin">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.printMarginColumn">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.wrapMode">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.tabSize">
    ...
    <tr>
        ...
        <select class="setting form-control" data-setting="codiad.editor.softTabs">
