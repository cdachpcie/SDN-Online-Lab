...
<table class="settings">
    <tr>
        ...
        <td>
            <select class="setting form-control" data-setting="codiad.editor.rightSidebarTrigger">
    ...
    <tr>
        ...
        <td>
            <select class="setting form-control" data-setting="codiad.editor.fileManagerTrigger">
    ...
    <tr>
        ...
        <td>
            <select class="setting form-control" data-setting="codiad.editor.persistentModal">
    ...
    <tr>
        ...
        <td>
            <select class="setting form-control" data-setting="codiad.settings.system.sync">
    ...
    <tr>
        ...
        <td>
            <select class="setting form-control" data-setting="codiad.settings.plugin.sync">
                <option value="true"><?php i18n("Yes") ?></option>
                <option value="false" default><?php i18n("No") ?></option>
            </select>
        </td>
