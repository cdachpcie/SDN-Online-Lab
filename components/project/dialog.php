    ...
    switch($_GET['action']){
        ...
        if(($projects) && $projects != ''){
            foreach($projects as $project=>$data){
                ...
                echo "You Have not created any yet.To create project please click on create button";          
            }    
            ?>
            </table>
            </div>
        ...
        case 'create':
            ...
            <input class="form-control" name="project_name" autofocus="autofocus" autocomplete="off">
            <label><?php i18n("Folder Name or Absolute Path"); ?></label>
            <input class="form-control" name="project_path" autofocus="off" autocomplete="off">
            <input type="hidden" name="user_name" value="<?php echo  $_SESSION['user'];?>" autofocus="off" autocomplete="off">
            ...
            <table class="hide" id="git-clone">
                <tr>
                    <td>
                        ...
                        <input class="form-control" name="git_repo">
                    </td>
                    <td width="5%">&nbsp;</td>
                    <td width="25%">
                        <label><?php i18n("Branch"); ?></label>
                        <input class="form-control" name="git_branch" value="master">
                    </td>
                </tr>
                <tr>
        ...
        ?>
        <form>
        <input class="form-control" type="hidden" name="project_path" value="<?php echo($_GET['path']); ?>">
        <label><span class="icon-pencil"></span><?php i18n("Rename Project"); ?></label>    
        <input class="form-control" type="text" name="project_name" autofocus="autofocus" autocomplete="off" value="<?php echo($_GET['name']); ?>">  
